...
function rerenderCurrentScreen(){syncLanguageChrome();if(currentScreen==='home-screen')renderHome();else if(currentScreen==='setup-screen'){if(session&&session.questions?.length===0)renderEmptyReview();else renderSetupScreen();}else if(currentScreen==='quiz-screen'&&session)renderCurrent();else if(currentScreen==='results-screen'&&lastResult)renderResultsScreen();else if(currentScreen==='review-screen'&&session)renderReviewScreen();}
